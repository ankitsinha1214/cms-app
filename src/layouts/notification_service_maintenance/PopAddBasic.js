...
function PopAddBasic(props) {
        ...
        axios({
            ...
            .then((response) => {
                if (response.data.success === true) {
                    const filteredData = response.data.data.filter((item) => item.role === "User");
    ...
    const reset = (event) => {
        ...
        values.title = "";
        values.description = "";
        values.userServiceAndMaintenance = "";
    ...
    const pop = () => {
        if (!values.title || !values.description || !values.userServiceAndMaintenance) return enqueueSnackbar('Please Fill All The Details !!!', { variant: 'error' })
        setIsBackdrop(false);
        createUser();
    ...
    const createUser = () => {
        ...
        const payload = {
            ...
            "userServiceAndMaintenance": values.userServiceAndMaintenance
        };
        axios({
            method: "post",
            url: process.env.REACT_APP_BASEURL + "notification-service-and-maintenance",
                        ...
                        <MDBox p={1} component="form" role="form">
                            ...
                            <MDBox p={1}>
                                <FormControl fullWidth>
                                    <InputLabel id="location-type-label">Username</InputLabel>
                                    <Select
                                        sx={{
                                            height: 50,
                                        }}
                                        labelId="userServiceAndMaintenance-label"
                                        id="userServiceAndMaintenance-select"
                                        value={values.userServiceAndMaintenance}
                                        name="userServiceAndMaintenance"
                                        onChange={handleChange}
                            ...
                            {/* <MDBox p={1}>
                                <FormControl fullWidth>
                                    <InputLabel id="location-type-label">Status</InputLabel>
                                    <Select
                                        sx={{
                                            height: 50,
                                        }}
                                    ...
                                    >
                                        <MenuItem value="Chargeup">Read</MenuItem>
                                        <MenuItem value="Chargeup1">Unread</MenuItem>
                                    </Select>
                                </FormControl>
                            </MDBox> */}
