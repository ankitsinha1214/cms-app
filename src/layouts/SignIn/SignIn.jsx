...
//                         </Typography>
//                 </MDBox> */}
//                 <MDBox textAlign="center" mx={2} mt={5} p={2} mb={1}>
//                  <Typography component="h1" variant="h5" className='forgotpassword'>
//                      Forgot your password? <a href="#" style={{ color: "#0043CE" }}>Reset password</a>
//                  </Typography>
//              </MDBox>
//         </MainLayout>
//     );
...
import MDButton from "components/MDButton";
import MainLayout from "layouts/authentication/components/MainLayout";
import bgImage from "assets/images/4.jpeg"
// import bgImage from "assets/images/login_bg.png";
...
function SignIn() {
    ...
    return (
        <MainLayout image={bgImage}>
            <Grid>
                <MDBox textAlign="left" mx={2} mt={-1} p={2} mb={0}>
                    <Typography component="h1" variant="h5" className='allhead'>
                        Welcome Back
                    </Typography>
                ...
                <MDBox pt={4} pb={3} px={3}>
                    <MDBox component="form" role="form">
                        ...
                        <MDBox mt={4} mb={1}>
                            <MDButton variant="gradient" fullWidth onClick={onSignIn} style={{ backgroundColor: "rgba(118, 198, 63, 1)", color: "rgba(255, 255, 255, 1)" }}>
                                {loading ? <CircularProgress size={20} sx={{ color: 'inherit' }} /> : 'Login'}
                            </MDButton>
                        </MDBox>
                    </MDBox>
