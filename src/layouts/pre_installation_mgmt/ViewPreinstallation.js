            ...
            <Grid item xs={12} sm={7}>
              ...
              <Grid container spacing={3} alignItems="center">
                ...
                <Grid item xs={12} sm={6} sx={{
                  ...
                  <Typography variant="body">Pre Installation done by </Typography>
        ...
        />
              ...
              <Grid item xs={12} sx={{ my: 4 }}>
                <Paper elevation={3} sx={{ p: 2 }}>
                  <Divider>
                    <Typography variant="h2">Meter room</Typography>
                  </Divider>
                  {/* <Typography variant="h3">Meter Room</Typography> */}
                  <Typography variant="h6" sx={{ mb: 4 }}>Electric sub meter</Typography>
                  {/* <Grid item xs={12}> */}
                  <ImageBox imageList={location?.state?.meterRoom?.electricSubMeter} />
                  <Typography variant="h6" sx={{ my: 2 }}>MCB</Typography>
                  <ImageBox imageList={location?.state?.meterRoom?.MCB} />
                  <Typography variant="h6" sx={{ my: 2 }}>RCCD</Typography>
                  <ImageBox imageList={location?.state?.meterRoom?.RCCD} />
                  {/* <Typography variant="h3" sx={{ my: 2 }}>RCCD</Typography> */}
              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Paper elevation={3} sx={{ p: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ my: 2 }}>Room to DC box</Typography>
                    <ImageBox imageList={location?.state?.conduit?.RoomToDcBox} />
                    <Typography variant="h6" sx={{ my: 2 }}>DC box to Charger</Typography>
                    <ImageBox imageList={location?.state?.conduit?.DcBoxToCharger} />
                ...
                <Grid item xs={12}>
                  <Paper elevation={3} sx={{ p: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ my: 2 }}>Charger</Typography>
                    <ImageBox imageList={location?.state?.civil?.charger} />
                    <Typography variant="h6" sx={{ my: 2 }}>DC box</Typography>
                    <ImageBox imageList={location?.state?.civil?.dcBox} />
                    {/* <VideoCanvas videoSrc={`${process.env.REACT_APP_AWS_BASEURL}${location?.state?.visibility?.videos}`} /> */}
                    {/* </Grid> */}
                  </Paper>
                </Grid>
...
export default ViewPreinstallation;