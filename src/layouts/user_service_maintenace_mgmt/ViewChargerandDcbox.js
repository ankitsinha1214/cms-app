    ...
    axios({
      ...
      .then((response) => {
        ...
        if (response.data.success === true) {
          ...
          setIsLoading(false);
          navigate("/service-maintenace/charger-and-dcbox");
        } else {
            ...
            <Grid item xs={12} sm={7}>
              ...
              <Grid container spacing={3} alignItems="center">
                ...
                <Grid item xs={12} sm={6} sx={{
                  ...
                  <Typography variant="body">Charger & Dcbox done by </Typography>
        ...
        />
              ...
              <Grid item xs={12} sx={{ my: 4 }}>
                <Paper elevation={3} sx={{ p: 2 }}>
                  ...
                  <Typography variant="h6" sx={{ mb: 4 }}>Charger</Typography>
                  {/* <Grid item xs={12}> */}
                  <ImageBox imageList={location?.state?.chargers?.charger} />
                  <Typography variant="h6" sx={{ my: 2 }}>DC Box</Typography>
                  <ImageBox imageList={location?.state?.chargers?.dcBox} />
            ...
            <Grid item xs={12} sm={5} display="flex" justifyContent="flex-end">
              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Paper elevation={3} sx={{ p: 2 }}>
                    <Divider>
                      <Typography variant="h3">Wiring</Typography>
                    </Divider>
                    <Typography variant="h6" sx={{ my: 2 }}>Charger</Typography>
                    <ImageBox imageList={location?.state?.wiring?.charger} />
                    <Typography variant="h6" sx={{ my: 2 }}>DC Box</Typography>
                    <ImageBox imageList={location?.state?.wiring?.dcBox} />
                ...
                <Grid item xs={12}>
                  <Paper elevation={3} sx={{ p: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ my: 2 }}>Floor</Typography>
                    <ImageBox imageList={location?.state?.paint?.floor} />
                    {/* <VideoCanvas videoSrc={`${process.env.REACT_APP_AWS_BASEURL}${location?.state?.visibility?.videos}`} /> */}
                    {/* </Grid> */}
                  </Paper>
                </Grid>
...
export default ViewChargerandDcbox;